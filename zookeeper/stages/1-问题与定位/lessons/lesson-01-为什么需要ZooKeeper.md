...
>
> 🧭 课程导航：[课程目录](../../../02-课程目录.md) · 上一课：[L0.3 Python 客户端 kazoo 入门](../../0-上手篇/lessons/lesson-0-3-Python客户端kazoo入门.md)（阶段 0 · 上手篇） · 下一课：L2《ZooKeeper 是什么：定位与能力地图》
>
> 🆕 **零基础读者**：建议先走 [阶段 0 · 上手篇](../../0-上手篇/overview.md)（L0.1 装环境 / L0.2 zkCli 增删改查 / L0.3 Python 客户端），把手感建立起来再回来读本课。已有基础可直接继续。
...
刚学完阶段 1《问题与定位》的课《为什么需要 ZooKeeper：双主故障之夜》知识点 双主与脑裂的本质、三道协调难题、为什么 MySQL+Redis 凑不齐，
请按大纲继续讲解下一课（课2：ZooKeeper 是什么：定位与能力地图）。
```

## 🧭 课程导航

⬅️ **上一课**：[L0.3 Python 客户端 kazoo 入门](../../0-上手篇/lessons/lesson-0-3-Python客户端kazoo入门.md)（阶段 0 · 上手篇）

➡️ **下一课**：[L2 ZooKeeper 是什么：定位与能力地图](lesson-02-ZooKeeper是什么.md)
