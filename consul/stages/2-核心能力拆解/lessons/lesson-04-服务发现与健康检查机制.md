...
![一眼全局图：名单记下来了，可谁来保证名单上的人还算数](../assets/lesson-04-global-health-check.svg)

> **看图**：服务来报到，花名册记下"名字 → 地址 → 身体状态"。它有四种办法判断还算不算数：主动敲门、让他自己报平安、真去调一次、或者别一直盯着问、改了再通知。要注意的坑是：**名字一样就算两台机器，划掉的是"这一份"，不是"这个服务"。**
