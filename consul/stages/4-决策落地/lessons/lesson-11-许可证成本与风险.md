...
![一眼全局图：它是免费的，但不一定是你不用花钱的那个](../assets/lesson-11-global-license-cost.svg)

> **看图**：往右走一步门槛高一层——自己用最省心，拿去卖钱要看条款写给谁，用到企业版功能才真花钱（一年一签还会涨）。但**真正的账往往不在"买不买"，而在"走不走得掉"**：人好不好招、换的代价多大、条款改了你只能跟着。越用越深越难走，这笔账最容易被漏掉。
...
> 🔧 **这五问"怎么做"，不在本课的范围内**：本课是**选型视角**——只负责让你识别"有没有人能扛"。
> 具体怎么监控 quorum、怎么轮换三类证书、怎么验证一次真恢复、怎么核验指标语义、怎么走升级路径，
> 见 **[子教程 · 运维专项](../../../子教程/运维专项/overview.md)**（8 课，按需学习，不进主线进度）。
