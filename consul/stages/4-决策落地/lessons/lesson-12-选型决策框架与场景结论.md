...
- **配套材料**：[08-实战经验](../../08-实战经验.md)｜[09-排障速查手册](../../09-排障速查手册.md)｜[10-场景解法库](../../10-场景解法库.md)
...
- **三类待办仍未完成**（与应用实战篇判定相关）：三份实战篇正文待写；08/09 需按本阶段内容扩容；现有实战项目需升级至"跨 ≥3 阶段"——这些已登记在[内容缺口台账](../../00-学习档案.md)，将在后续处理。
