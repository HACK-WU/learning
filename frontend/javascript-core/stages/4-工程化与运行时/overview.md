...
- 理解 `CommonJS` 与 `ESM` 的差异在**加载时机**，不在语法——ESM 的静态结构更适合稳定 tree-shaking，CommonJS 的动态写法会削弱分析能力。
...
| 知识点 | 所属课 | 学完应能 |
|--------|--------|----------|
| CommonJS 与 ESM | 课 10 | 说清"实时绑定"与"缓存导出值 / 解构快照"的差异及后果；解释为什么 ESM 更适合稳定 tree-shaking |
