...
> 汇总完成时间：2026-08-31；**2026-09-14 更新**：补齐阶段 6–7（课 15–19），并为全 19 课统一新版讲义规范（见 [讲义读法说明](#讲义读法说明2026-09-14-全-19-课统一规范)）。
...
8 道开放设计题，每道给 ≥3 个解法（含代价与适用边界）+ 推荐路径 + 知识点挂钩，**每场景独立成篇**：
...
> 解法全部折叠，**先自己想 30 秒再展开**。索引页有「六问思考框架」，用于应对没见过的场景；通览全部：[场景解法库索引](10-场景解法库/INDEX.md)。
