# 开发（Redis Docs · 共 13 条）

> 范围：redis.io/docs/latest（官方 llms.txt 精选面）· 生成日期：2026-09-10 · 数据类型/搜索/PubSub/Streams/Lua/淘汰策略/分布式锁

| 我要… | 去哪一页 | 关键词 | 相关 |
|-------|----------|--------|------|
| 看开发主题总览 | [develop/index.html.md](https://redis.io/docs/latest/develop/index.html.md) | 开发 | |
| 理解 Redis 数据类型（String/Hash/List/Set/ZSet/Stream） | [develop/data-types/index.html.md](https://redis.io/docs/latest/develop/data-types/index.html.md) | 数据类型 | |
| 用搜索与二级索引（全文/过滤查询） | [develop/interact/search-and-query/index.html.md](https://redis.io/docs/latest/develop/interact/search-and-query/index.html.md) | search | |
| 存向量与 kNN 检索（HNSW/flat） | [develop/interact/search-and-query/advanced-concepts/vectors/index.html.md](https://redis.io/docs/latest/develop/interact/search-and-query/advanced-concepts/vectors/index.html.md) | vector | |
| 建搜索索引（聚合/过滤） | [develop/interact/search-and-query/indexing/index.html.md](https://redis.io/docs/latest/develop/interact/search-and-query/indexing/index.html.md) | index | |
