...
按 topic-teach 最新 skill 的「课级入口要素」硬约束，本阶段课 7-10已全部补齐六项要素（一句话本质 / 处境对照 / 一眼全局图 + 读图指引 / 本课地图 / 📖 文档核对 / 🧭 知识点衔接句），经 `verify.sh` 全量核验 P0=0。

**本阶段新增全局图**：lesson-07-固定门牌挡住会变的地址.svg、lesson-08-一个门外加认路的前台.svg、lesson-09-暗号变成规矩再分三层.svg、lesson-10-楼里每扇门都不锁.svg
