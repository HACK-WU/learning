...
> **[15 · 从裸索引到自动滚动归档](../../../应用实战/15-索引管理与生命周期策略.md)**
...
2. 接着生成 Phase 5 的三份收尾产物：
   ...
   - ../../../10-场景解法库/INDEX.md（设计态：多解法权衡 + 先想后看）
...
- **返回目录**：[课程目录](../../../02-课程目录.md) ｜ [学习档案](../../../00-学习档案.md) ｜ [学习路径总览](../../../01-学习路径总览.md)
...
- 动手做本课实战：[**15 · 从裸索引到自动滚动归档**](../../../应用实战/15-索引管理与生命周期策略.md)
