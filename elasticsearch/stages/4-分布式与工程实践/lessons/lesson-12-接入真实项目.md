...
> **[12 · 让 ES 跟上数据库](../../../应用实战/12-接入真实项目.md)**
...
| 上一课 | 本课 | 下一课 |
|--------|------|--------|
| [课11 数据管道与备份](lesson-11-数据管道与备份.md) | **课12 接入真实项目** | [阶段 5 生产与选型](../../5-生产与选型/overview.md) ｜ [返回课程目录](../../../02-课程目录.md) ｜ [学习档案](../../../00-学习档案.md) ｜ [学习路径总览](../../../01-学习路径总览.md) |

---

## 🎯 练一练

- 动手做本课实战：[**12 · 让 ES 跟上数据库**](../../../应用实战/12-接入真实项目.md)
