...
| `boolean` | 布尔 | |
| `object` | 嵌套对象 | 数组会被"扁平化"（课 16 讲 nested） |
| `nested` | 对象数组独立查询 | 解决 object 数组关联丢失（课 16 展开） |
| `flattened` | 整个对象当一个字段 | 压字段数，不保配对（课 16 展开） |
...
> 课里学的是原理，动手才叫会用。本课的实战篇在这里：
> **[05 · 一个字段类型选错，返工重建索引](../../../应用实战/05-映射给数据定规矩.md)**
> 场景驱动、全部结论本机实测，每个演进一步各配一张分步设计图。
> 更多实战见 [应用实战索引](../../../应用实战/INDEX.md)。
...
- **返回**：[课程目录](../../../02-课程目录.md) ｜ [学习档案](../../../00-学习档案.md) ｜ [学习路径总览](../../../01-学习路径总览.md)

---

## 🎯 练一练

- 动手做本课实战：[**05 · 一个字段类型选错，返工重建索引**](../../../应用实战/05-映射给数据定规矩.md)
- 全部实战术引：[应用实战索引](../../../应用实战/INDEX.md)
