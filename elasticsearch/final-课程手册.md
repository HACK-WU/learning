...
| 新要求来了怎么设计 | [10 · 场景解法库](10-场景解法库/INDEX.md)（8 个场景，多解法权衡，先想后看） |
...
| 你想干什么 | 去哪 | 姿态 |
|-----------|------|------|
| 新需求来了，怎么设计 | [10 · 场景解法库](10-场景解法库/INDEX.md) | 设计态：8 个场景，每个 4-6 个解法 + 代价 + 推荐路径（`<details>` 折叠，先想后看） |
...
**相关文档**：[学习路径总览](01-学习路径总览.md) ｜ [课程目录](02-课程目录.md) ｜ [学习档案](00-学习档案.md) ｜ [评审清单](00-评审清单.md) ｜ [实战经验](08-实战经验.md) ｜ [排障速查手册](09-排障速查手册.md) ｜ [场景解法库](10-场景解法库/INDEX.md)
