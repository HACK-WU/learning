...
> **汇总手册** —— 4 阶段 / 10 课的完整索引与决策摘要；知识点级进度以[学习档案](00-学习档案.md)和[课程目录](02-课程目录.md)为准。
...
**收尾三件套**：[08-实战经验](08-实战经验.md)（为什么会崩） ｜ [09-排障速查手册](09-排障速查手册.md)（崩了怎么止血） ｜ [10-场景解法库](10-场景解法库/INDEX.md)（新需求怎么设计） ｜ [应用实战](应用实战/INDEX.md)（动手到会用）
...
| 新需求要设计 | [10-场景解法库](10-场景解法库/INDEX.md) |
...
| 新需求来了要设计 | [10-场景解法库](10-场景解法库/INDEX.md)（11 个场景、53 个解法各配一张机制图，**先想后看**） |
...
- **避坑**：复制"给我讲讲 Celery 的实战经验、排障手册与场景解法库" —— 三份已完成：
  [08-实战经验.md](08-实战经验.md) ｜ [09-排障速查手册.md](09-排障速查手册.md) ｜ [10-场景解法库/](10-场景解法库/INDEX.md)
- **动手到会用**：[应用实战/](应用实战/INDEX.md)（7 篇真实故障现场，配分步 SVG）。
